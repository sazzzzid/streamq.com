/** Canonical production domain for StreamQ marketing site. */
export const SITE_DOMAIN = "streamq.in" as const

export const PRODUCTION_SITE_URL = `https://${SITE_DOMAIN}` as const

export const SITE_BRAND = "StreamQ" as const

export const SITE_PRODUCT_NAME = "StreamQ Player" as const
